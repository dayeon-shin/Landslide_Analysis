...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark py-lg-4" id="mainNav">
    <h2 class="text-white text-bold" style="text-align:left">Status of national landslides</h2>
  	...
  	<form method="get" action="/search.do">
	  	<div id = "search">
			...
			<input type="text" id="searchStr" value="시도군구명" name="city">
...
<%-- <c:forEach items="${ranksi}" var="rank">
  <div class="sidenav">
	  <a href="none" class="font-weight-bold" >RANKING</a>
...
<div class="row">
  ...
  <div id="table1" class="col-3"style="height: 1200px;">
    <table>
        ...
        <tr><td>원하는 지역을 선택시 해당 정보가 나타납니다.</td></tr>
        <tr><th>지역별 강수량</th></tr> 
		<tr><td>원하는 지역을 선택시 해당 정보가 나타납니다.</td></tr>
  ...
  <div id="table2" class="col-3"style="height: 1200px;">
    <table>
        ...
        <tr><th>지역별 산사태 발생 건수</th></tr>
        <tr><td id="chart1">테이블2</td></tr>
        <tr><th>지역별 강수량</th></tr> 
		<tr><td id="bar">테이블2</td></tr>
