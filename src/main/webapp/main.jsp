...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark py-lg-4" id="mainNav">
    <h2 class="text-white text-bold" style="text-align:left; padding-left:30px;">Status of national landslide</h2>
     
     <div id = "search" style=" padding-left:16.5%;">
   ...
   <input type="submit" value="검색"  style="height:45px;">
    ...
    <div class="sidenav" id="sidenav" style="background: rgb(246,199,75);">
